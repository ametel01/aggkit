...
# Contract addresses - read from mounted .env file if available
if [[ -n "$AGGKIT_ENV_FILE" && -f "$AGGKIT_ENV_FILE" ]]; then
    echo "Reading contract addresses from $AGGKIT_ENV_FILE"
    source "$AGGKIT_ENV_FILE"
fi

# Use the correct rollup contract address based on which L2 we're configuring
POLYGON_ZKEVM_L1=${POLYGON_ZKEVM_L2_ROLLUP:-${POLYGON_ZKEVM_L3_ROLLUP:-"0xDc64a140Aa3E981100a9becA4E685f962f0cF6C9"}}
...
POLYGON_ZKEVM_GLOBAL_EXIT_ROOT_L2=${POLYGON_ZKEVM_GLOBAL_EXIT_ROOT_L2:-${GLOBAL_EXIT_ROOT_MANAGER_L2:-"0xe7f1725E7734CE288F8367e1Bb143E90bb3F0512"}}
